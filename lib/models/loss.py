...
class MultiLevelDetectionLoss(nn.Module):
    ...
    def forward(self, pred_hms, pred_regs, gt_hms, gt_regs, masks):
        ...
        total_cls_loss, total_reg_loss, total_num_pos, total_iou_loss, total_offset_loss = 0, 0, 0, 0, 0
        ...
        total_reg_loss = total_iou_loss + total_offset_loss
        ...
        return tot_loss, cls_loss, reg_loss, total_iou_loss / total_num_pos, total_offset_loss / total_num_pos